...
class ControlNetConditioningEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.conv_in_structure = Convolution(
            spatial_dims=spatial_dims,
            in_channels=4,
            out_channels=num_channels[0],
            strides=1,
        ...
        self.conv_combined = nn.Conv2d(
            in_channels=32,  # Current number of channels
            out_channels=16,  # Target number of channels
    ...
    def forward(self, conditioning):
        tumor, structure = conditioning #### change_13jan2025 ####
        ...
        embedding = self.conv_combined(embedding)
...
class ControlNet(nn.Module):
    ...
    def forward(
        ...
        controlnet_cond = self.controlnet_cond_embedding(controlnet_cond) #### change ####
